...
index.add({
  tags: ["MATLAB","Fibonacci sequence","recursive","function","recursive function","branching","isreal","round","str2double","input","string","for-loop","timeit","performance","tab","disp","char"],
  id: 35
})
index.add({
...
var store = [{
  ...
  "category": null,
  "tags": ["MATLAB","Fibonacci sequence","recursive","function","recursive function","branching","isreal","round","str2double","input","string","for-loop","timeit","performance","tab","disp","char"],
  "excerpt": "MATLAB Problem Part A Consider the MATLAB function fib(). Modify this function using MATLAB’s built-in timeit() function such that fib()..."
},{
  ...
  "category": null,
  "tags": ["Python","Amino Acid","input","output","IO","command line","argument","exception handling","exception","for-loop","dictionary","map"],
  "excerpt": "Problem Python Consider this data file. It contains information about the amino-acids in a protein called 1A2T. Each amino-acid in..."
},{
