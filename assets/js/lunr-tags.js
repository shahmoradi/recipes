...
index.add({
  tags: ["MATLAB","Python","regression","visualization","plot","line","figure","random number","distribution function","probability density function","PDF","probability","objective function","maximum likelihood method","Monte Carlo","Markov Chain","MCMC","ParaMonte"],
  id: 1
})
index.add({
