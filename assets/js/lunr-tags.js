...
index.add({
  tags: ["Excel","visualization","data","input","output","figure","texas","population","transformation","logarithm"],
  id: 0
})
index.add({
  tags: ["integer","memory","IEEE","storage","real","float","real32","real64","real128"],
  id: 1
})
index.add({
...
index.add({
  tags: ["Python","MKL","matmul","matrix","multiplication","performance","optimization","hpc"],
  id: 6
})
index.add({
  tags: ["Python","MKL","matmul","matrix","multiplication","performance","optimization","hpc"],
...
index.add({
  tags: ["Python","performance","optimization","hpc"],
  id: 8
})
index.add({
  tags: ["Python","performance","optimization","sorting","binary","linear","search","array","hpc"],
  id: 9
})
index.add({
  tags: ["Python","performance","optimization","hpc"],
...
index.add({
  tags: ["plausibility","deduction","reasoning","logic","boolean","venn","diagram","truth","table"],
  id: 78
})
index.add({
...
index.add({
  tags: ["Python","OOP","object","class","instantiation","inheritance","differentiation","projectile"],
  id: 86
})
index.add({
  tags: ["Python","OOP","object","class","instantiation","inheritance","differentiation","parabola"],
  id: 87
})
index.add({
...
var store = [{
  "title": "Better visualizations through axes transformation.",
  "link": "/programming/vis-excel-axis-transformation/vis-excel-axis-transformation",
  "date": "April 29, 2024",
  "category": null,
  "tags": ["Excel","visualization","data","input","output","figure","texas","population","transformation","logarithm"],
  "excerpt": "Problem Consider the following dataset containing the population of Texas cities. Our goal is to visualize the population of Texas..."
},{
  "title": "IEEE-storage convention for real numbers",
  "link": "/programming/digital-storage-real-number/digital/digital-storage-real-number",
  "date": "February 25, 2023",
  "category": "digital",
  "tags": ["integer","memory","IEEE","storage","real","float","real32","real64","real128"],
  "excerpt": "Recall that computers can only store discrete values in memory. What does this imply for the storage of real (floating-point)..."
},{
  "title": "Intel OneAPI C/C++/Fortran Compiler Installation",
  "link": "/programming/intel-oneapi-c-cpp-fortran-compiler-installation/intel-oneapi-c-cpp-fortran-compiler-installation",
  "date": "January 1, 2023",
  "category": null,
  "tags": ["Intel Parallel Studio","Microsoft Visual Studio","Windows","installation","Fortran","C","C++"],
  "excerpt": "Problem How can I install the Intel OneAPI C/C++/Fortran Compiler on Windows, Linux, or macOS? Solution The Intel OneAPI HPC..."
},{
  "title": "Logic NAND and NOR",
  "link": "/programming/logic-nand-nor/logic/logic-nand-nor",
  "date": "November 1, 2022",
  "category": "logic",
  "tags": ["plausibility","deduction","reasoning","logic","boolean","implication"],
  "excerpt": "Recall the definitions of NAND and NOR from our lecture notes. Show that, \\[\\overline{(A \\uparrow A) \\downarrow (B \\uparrow B)}..."
},{
  "title": "Logical implication in terms of logic functions",
  "link": "/programming/logic-functions-implication/logic-functions-implication",
  "date": "October 21, 2022",
  "category": null,
  "tags": ["plausibility","deduction","reasoning","logic","boolean","implication"],
  "excerpt": "Consider the following logic functions, Show that, \\[f_1(A, B) + f_3(A, B) + f_4(A, B)\\] is equivalent to logical implication..."
},{
  "title": "Version-control: Setting up Git Software and GitHub Account",
  "link": "/programming/vcs-git-github-setup/vcs-git-github-setup",
  "date": "September 13, 2022",
  "category": null,
  "tags": ["VCS","git","GitHub","version control system","project","markdown","git branch"],
  "excerpt": "Git This exercise guides you through the steps needed to take to properly install and minimally use the git software..."
},{
  "title": "Performance benchmarking of naive matrix multiplication in Python vs. optimized libraries",
  "link": "/programming/hpc-matmul-python/hpc-matmul-python",
  "date": "April 17, 2022",
  "category": null,
  "tags": ["Python","MKL","matmul","matrix","multiplication","performance","optimization","hpc"],
  "excerpt": "Problem Write a Python function with the following interface that computes the matrix multiplication of two input matrices. def matmul(matA,..."
},{
  "title": "Performance benchmarking of naive matrix multiplication: naive vs. matmul vs. MKL",
  "link": "/programming/hpc-matmul-mkl/hpc-matmul-mkl",
  "date": "April 17, 2022",
  "category": null,
  "tags": ["Python","MKL","matmul","matrix","multiplication","performance","optimization","hpc"],
  "excerpt": "Problem Unlike The C/C++ programming languages, The Fortran language has native functions for matrix operations. The most important of these..."
},{
  "title": "Performance optimization: loop invariant code motion",
  "link": "/programming/hpc-loop-invariant-code-motion/hpc-loop-invariant-code-motion",
  "date": "April 17, 2022",
  "category": null,
  "tags": ["Python","performance","optimization","hpc"],
  "excerpt": "Problem Consider the following Python code snippet, import numpy as np const = 256. x = [i for i in..."
},{
  "title": "Performance optimization: Searching sorted array via linear vs. binary search",
  "link": "/programming/hpc-linear-binary-search/hpc-linear-binary-search",
  "date": "April 17, 2022",
  "category": null,
  "tags": ["Python","performance","optimization","sorting","binary","linear","search","array","hpc"],
  "excerpt": "Problem Recall our discussion of linear vs. binary searching of sorted arrays for a particular value. Suppose we a set..."
},{
  "title": "Performance optimization: Forced reduction - sin(x)cos(y) + cos(x)sin(y)",
  "link": "/programming/hpc-forced-reduction-sinxpy/hpc-forced-reduction-sinxpy",
  "date": "April 17, 2022",
  "category": null,
  "tags": ["Python","performance","optimization","hpc"],
  "excerpt": "Problem Consider the following Python function, import numpy as np def getSCCS_slow(x, y): \"\"\" Return `sin(x) * cos(y) + cos(x)..."
},{
  "title": "Performance optimization: Forced reduction - sincos",
  "link": "/programming/hpc-forced-reduction-sincos/hpc-forced-reduction-sincos",
  "date": "April 17, 2022",
  "category": null,
  "tags": ["Python","performance","optimization","hpc"],
  "excerpt": "Problem Consider the following Python function, import numpy as np def sincos(x): \"\"\" Return `sin(x) * cos(x)`. \"\"\" return np.sin(x)..."
},{
  "title": "Performance optimization: Forced reduction - hidden opportunities",
  "link": "/programming/hpc-forced-reduction-exp/hpc-forced-reduction-exp",
  "date": "April 17, 2022",
  "category": null,
  "tags": ["Python","performance","optimization","hpc"],
  "excerpt": "Problem Consider the following Python function, import numpy as np def count(xvec): \"\"\" Return the count of elements of the..."
},{
  "title": "Performance optimization: Breaking out of loop early",
  "link": "/programming/hpc-breaking-out-of-loop-early/hpc-breaking-out-of-loop-early",
  "date": "April 17, 2022",
  "category": null,
  "tags": ["Python","performance","optimization","hpc"],
  "excerpt": "Problem Consider the following Python function, def any(boolVec): \"\"\" Return True if any of the elements of the input value..."
},{
  ...
  "title": "Puzzle: How many and what living creatures do you see?",
  "link": "/programming/puzzle-how-many-animals-in-pond/puzzle-how-many-animals-in-pond",
  "date": "November 15, 2021",
  "category": null,
  "tags": ["matchstick","equation","puzzle"],
  "excerpt": "\n\n    \n        \n            \n                Problem\n            \n        \n    \n\n\nHow many and what living creatures can you identify in this picture?\n\n    \n\n\n"
},{
  ...
  "title": "Venn diagram representation of Boolean identities",
  ...
  "title": "Truth table representation of Boolean identities",
  "link": "/programming/logic-boolean-algebra-truth-table/logic/logic-boolean-algebra-truth-table",
  "date": "September 30, 2020",
  "category": "logic",
  "tags": ["plausibility","deduction","reasoning","logic","boolean","venn","diagram","truth","table"],
  ...
  "title": "Projectile motion implementation through OOP multiple inheritance",
  "link": "/programming/oop-projectile/oop-projectile",
  "date": "June 30, 2020",
  "category": null,
  "tags": ["Python","OOP","object","class","instantiation","inheritance","differentiation","projectile"],
  "excerpt": "Problem Consider the problem of projectile motion in purely vertical direction that we solved in class. Here is the class..."
},{
  "title": "Parabola as a subclass of line",
  "link": "/programming/oop-parabola/oop-parabola",
  "date": "June 30, 2020",
  "category": null,
  "tags": ["Python","OOP","object","class","instantiation","inheritance","differentiation","parabola"],
  "excerpt": "Problem Recall the equation for a line is given by $f(x) = c_0 + c_1 x$ where $c_0$ and $c_1$..."
},{
